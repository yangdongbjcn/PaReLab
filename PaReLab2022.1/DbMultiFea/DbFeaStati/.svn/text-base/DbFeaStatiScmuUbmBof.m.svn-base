function result = DbFeaStatiScmuUbmBof(nd_cells, image_labels, cluster_num, sample_num, data_format, zoom_size)
	
	result = DbFeaStatiUbm(nd_cells, image_labels, cluster_num, sample_num, 'scmu');
	UBM = result{1};
	gmm_cells = result{2};
