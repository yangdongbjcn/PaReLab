function [beta] = spm(sc_codes, pyramid, img_width, img_height, data_x, data_y, method)
...
for iter1 = 1:pLevels,
    ...
    xBin = ceil(data_x / wUnit);
    yBin = ceil(data_y / hUnit);
    ...
    for iter2 = 1:nBins,
		...
		switch method
			...
			case 'sum'
				beta(:, bId) = sum(sc_codes(:, sidxBin), 2);
		end
    end
end
