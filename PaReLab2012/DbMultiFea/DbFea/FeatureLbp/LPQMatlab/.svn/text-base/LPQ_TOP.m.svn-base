...
%
% Version published in 2010 by Juhani Päivärinta, Esa Rahtu, and Janne Heikkil?
...
for index1 = 1:size(Temp_Volume_XT,3) 
     G = single(Temp_Volume_XT(:,:,index1));
...
for index2 = 1:size(Temp_Volume_YT,3)
     G = single(Temp_Volume_YT(:,:,index2));
...
%
%
% Based on the original LPQ (published by Janne Heikkil? Esa Rahtu, and Ville Ojansivu)
% Machine Vision Group, University of Oulu, Finland
%
